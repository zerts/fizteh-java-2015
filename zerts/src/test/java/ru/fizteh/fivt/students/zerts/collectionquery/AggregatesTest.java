...
public class AggregatesTest extends TestCase {
    ...
    public void testMax() throws Exception {
        ...
        assertEquals(((Aggregator) Aggregates.max(functionName)).apply(exampleList), "zertsalov");
    ...
    public void testMin() throws Exception {
        ...
        assertEquals(((Aggregator) Aggregates.min(functionName)).apply(exampleList), "iglina");
