...
public class TwitterQueryTest extends TestCase {
    ...
    public void testGetFormattedTweets() throws Exception {
        ...
        assertThat(tweets, hasItems("[8 дней назад] @Owl_Juliann_: Рђ РјС‹ СЃРµРіРѕРґРЅСЏ СЃ Р’РёРєРѕР№ "
                + "РґРѕР±СЂР°Р»РёСЃСЊ РЅР°РєРѕРЅРµС†-С‚Рѕ РґРѕ С‡Р°Р№РЅС‹С… РґРµР» РјР°СЃС‚РµСЂСЃРєРѕР№! "
                + "РќР° СѓРґРёРІРёС‚РµР»СЊРЅРѕР№ С„Р°СЂРІРѕСЂРѕРІРѕР№вЂ¦ https://t.co/nenvrVtV0o\n--------"
                + "----------------------------------------------------------------------------------------"
                + "--------------------------------------------------------------------------\n"));
